...
export default function BaptismForm({
    ...
    // Initialize sponsors if not present
    useEffect(() => {
    ...
    // Step validation (final step check only)
    useEffect(() => {
        ...
        const validator = () => {
            ...
            if (formData.phone && !phoneRegex.test(formData.phone)) {
                errs.contactNumber = "Phone must start with 09 and be 11 digits";
            }
                        ...
                        {[
                            ...
                            >
                                <input
                                    ...
                                    onChange={(e) => updateField("parentsMarriageType", e.target.value)}
