...
import ConfirmDialog from "../../ui/ConfirmDialog.jsx"; // ✅ import dialog
    ...
    const menuItems = [
        {
            icon: User,
            label: "Profile",
            path: "/admin/settings?tab=personal_info",
                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="p-2 border-t border-gray-200">
                            <button
                                onClick={() => setShowLogoutDialog(true)} // ✅ now shows confirmation dialog
