    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm flex flex-col max-h-[800px]">
                {/* Header - Now fully responsive with proper wrapping */}
                <div className="p-4 border-b border-gray-100 flex flex-col gap-3">
                    ...
                    {/* Range selector row - full width on mobile */}
                ...
                <div className="flex-1 overflow-x-auto overflow-y-auto custom-scrollbar">
                    <table className="w-full divide-y divide-gray-200 text-xs md:text-sm min-w-[800px]">
                ...
                {total > 0 && (
                    <div className="border-t px-3 py-3 md:px-4 md:py-4 flex flex-col sm:flex-row justify-between items-center gap-3">
