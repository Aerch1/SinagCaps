...
const BarTooltip = ({ active, payload, label }) => {
    ...
    return (
        <div className="min-w-[200px] rounded-lg border border-gray-200 bg-white p-3 shadow-lg dark:border-slate-700 dark:bg-slate-800">
                ...
                {Object.entries(row.services).map(([service, count]) => (
                    <div key={service} className="flex items-center justify-between text-xs">
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <span className="text-gray-600 dark:text-slate-400">{service}</span>
                        </div>
...
const ServiceBarChart = ({ filter }) => {
    ...
    return (
        <div className="flex h-full flex-col rounded-lg border border-gray-200 bg-white p-4 md:p-6 dark:border-slate-700 dark:bg-slate-800">
            {/* Header */}
