  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span
          className={displayValue === placeholder ? "text-gray-400" : "text-gray-900"}
        >
          {displayValue}
        </span>
        <ChevronDown
          className={`absolute right-3 h-4 w-4 text-gray-400 transition-transform ${
            isOpen ? "rotate-180" : ""
          } ${disabled ? "opacity-50" : ""}`}
        />
      </div>
        ...
        <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-[100] overflow-hidden">
          <div className="p-3 grid grid-cols-3 gap-3">
            ...
            <div className="relative">
              <select
                className="w-full h-9 pl-2 pr-8 text-xs border border-gray-200 rounded-md bg-gray-50 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 focus:outline-none appearance-none"
            ...
            <div className="relative">
              <select
                className="w-full h-9 pl-2 pr-8 text-xs border border-gray-200 rounded-md bg-gray-50 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 focus:outline-none appearance-none"
                value={
                  tempDate.day || (currentDate ? String(currentDate.getDate()).padStart(2, "0") : "")
                }
