...
export default function SlotSelector({
    ...
    const { slots = [], loading } = useAvailability(serviceId, date);
    ...
    // ✅ Check if the chosen date is a closed day
                        ...
                        <div className="mb-3">
                            ...
                            <div className="grid grid-cols-3 gap-2 max-h-[240px] overflow-y-auto pr-1 custom-scrollbar">
                                {slots.map((s) => {
                                    ...
                                    const label = s.unavailable
                                        ? `${to12h(cleanTime)} (Full)`
                                        : s.capacity > 1
                                            ? `${to12h(cleanTime)} (${s.booked}/${s.capacity} booked)`
                                            : `${to12h(cleanTime)} (${s.remaining} left)`;
