  ...
  return (
    <div className="w-full relative overflow-visible">
      ...
      <Popover>
        ...
        {/* ✅ FIX: Ensure popover always renders above modals/cards */}
        <PopoverContent
          align="start"
          side="bottom"
          sideOffset={6}
          avoidCollisions={false}
          className="z-[9999] p-0 bg-white border border-gray-200 shadow-lg rounded-md overflow-visible"
        >
          <div className="relative">
            ...
            <Calendar
              ...
              modifiersClassNames={{
                ...
                full:
                  "bg-yellow-100 text-yellow-800 hover:bg-yellow-200 aria-selected:bg-yellow-200",
                blocked:
