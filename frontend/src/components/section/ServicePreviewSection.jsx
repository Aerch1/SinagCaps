...
export default function ServiceAvailabilityPreview() {
    ...
    const [selectedTime, setSelectedTime] = useState(""); // ✅ NEW: Track selected time
    ...
    // ✅ NEW: Continue to appointment with pre-filled data
    const handleContinueToAppointment = () => {
        ...
        // Store the pre-filled data in localStorage
        const prefilledData = {
            service_id: serviceId,
            serviceName: serviceName,
            formType: selectedService?.form_type || "default",
            preferredDate: selectedDate,
            preferredTime: selectedTime,
            extraData: {},
        };

        localStorage.setItem("appointment_prefilled", JSON.stringify(prefilledData));
        localStorage.setItem("appointment_startStep", "3");

        // Navigate to appointment page with correct route
            ...
            <div className="max-w-lg mx-auto mb-10">
                ...
                <Dropdown
                    ...
                    onChange={(name) => {
                        ...
                        setAvailableTimes([]);
                        setSelectedDate("");
                        setSelectedTime(""); // ✅ Reset time when changing service
                    }}
                ...
                <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div className="p-6 text-slate-700">
                        {!selectedDate ? (
                            ...
                            <>
                                <div className="space-y-2 max-h-96 overflow-y-auto scroll-thin mb-4">
                                ...
                                {/* ✅ Continue Button - Only shows when time is selected */}
                                {selectedTime && (
                                    <button
                                        type="button"
